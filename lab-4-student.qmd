...
ca_childcare |>
  ...
  summarise(
    mc_infant_median = median(mc_infant, na.rm = TRUE),
    mc_toddler_median = median(mc_toddler, na.rm = TRUE),
    mc_preschool_median = median(mc_preschool, na.rm = TRUE),
    .groups = "drop") |>
  pivot_longer(cols = starts_with("mc_"),
               names_to = "age_group",
               values_to = "median_cost") |>
  mutate(age_group = fct_relevel(fct_recode(age_group,
                                          "Infant" = "mc_infant_median",
                                          "Toddler" = "mc_toddler_median",
                                          "Preschool" = "mc_preschool_median"),
                                "Infant",
                                "Toddler",
                                "Preschool")) |>
  ...
  geom_line(linewidth = 2, alpha = 0.3, show.legend = FALSE) +
